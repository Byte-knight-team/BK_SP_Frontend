  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      <div className="w-full max-w-sm rounded-4xl border border-gray-100 bg-white p-8 shadow-2xl">
        ...
        <h3 className="text-xl font-bold text-gray-900 mb-1">Cancel Order</h3>
        <p className="text-sm text-gray-400 mb-6">Provide a reason for cancelling this order.</p>
        <textarea
          rows={3}
          value={reason}
        ...
        <div className="flex gap-4">
          ...
          <button onClick={handleConfirm} disabled={isLoading || !reason.trim()}
            className="flex-1 rounded-2xl bg-red-500 py-3 text-sm font-bold text-white disabled:bg-gray-300 disabled:cursor-not-allowed">
