        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="text-xs text-gray-400 uppercase tracking-wider border-b border-gray-100">
              <th className="text-left pb-3 font-semibold w-[25%]">Staff Member</th>
              <th className="text-center pb-3 font-semibold w-[15%]">Role</th>
              <th className="text-left pb-3 font-semibold w-[15%] pl-4">Hire Date</th>
              <th className="text-left pb-3 font-semibold w-[20%]">Contact</th>
              <th className="text-left pb-3 font-semibold w-[15%]">Salary</th>
          ...
          <tbody className="divide-y divide-gray-50">
            {displayedItems.map((member) => (
              <tr key={member.userId} className="hover:bg-gray-50/50 transition-colors">
                ...
                <td className="py-4 text-sm text-gray-500 pl-4">
                  {member.hireDate}
                </td>
