          ...
          <div className="flex flex-col">
            ...
            {!isCollapsed && isMenuDropdownOpen && (
              <div className="mt-2 ml-4 flex flex-col gap-1 border-l-2 border-gray-100 pl-2">
                ...
                <Link to="/admin/menu?status=pending" className={getSubLinkClass('/admin/menu?status=pending')}>
                  <div className="w-1.5 h-1.5 rounded-full bg-red-500 mr-1"></div>
                  Pending
                </Link>
                <Link to="/admin/menu?status=reject" className={getSubLinkClass('/admin/menu?status=reject')}>
                  <div className="w-1.5 h-1.5 rounded-full bg-rose-600 mr-1"></div>
                  Reject
                </Link>
              </div>
            )}
