...
export const InventoryService = {
  ...
  addItem: async (itemData) => {
    const response = await authFetch(`${BASE_URL}/api/inventory/items`, {
      method: 'POST',
  ...
  restockItem: async (itemId, restockData) => {
    const response = await authFetch(
      `${BASE_URL}/api/inventory/items/${itemId}/restock`,
      {
        method: 'PATCH',
  ...
  removeStock: async (itemId, removeData) => {
    const response = await authFetch(
      `${BASE_URL}/api/inventory/items/${itemId}/remove`,
      {
        method: 'PATCH',
  ...
  correctItem: async (itemId, correctionData) => {
    const response = await authFetch(
      `${BASE_URL}/api/inventory/items/${itemId}/correct`,
      {
        method: 'PUT',
  ...
  resolveChefRequest: async (requestId, resolutionData) => {
    const response = await authFetch(
      `${BASE_URL}/api/inventory/chef-requests/${requestId}/resolve`,
      {
        method: 'PATCH',
