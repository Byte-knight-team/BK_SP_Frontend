 ...
 * @param {Object} params - { active, type, page, size }
 * @returns {Promise<Response>} { data: { orders: [...], page, size, totalElements, totalPages, last } }
 */
 ...
 * @returns {Promise<Response>} { data: [{ reviewId, customerName, rating, comment, createdAt }, ...] }
 */
